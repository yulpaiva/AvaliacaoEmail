<?php
	...
	try {
        ...
        $mail->Password   = 'Pain2014';                               //SMTP password
        ...
        $mail->Body    = utf8_decode($mensagem->__get('rating_value'). ',' .  $mensagem->__get('mensagem'));
...
/* Template
	...
	try {
        ...
        //Recipients
        $mail->setFrom('xxyulxx@outlook.com', 'Yul Remetente');         //remetente
        $mail->addAddress('xxyulxx@outlook.com', 'Yul Destinatário');     //Add a recipient
        $mail->addAddress('yulbrynner73@gmail.com');               //Name is optional
        //$mail->addReplyTo('info@example.com', 'Information');
        //$mail->addCC('cc@example.com');
        //$mail->addBCC('bcc@example.com');
